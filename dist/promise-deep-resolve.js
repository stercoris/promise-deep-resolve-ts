...
exports.resolveNestedPromises = void 0;
const promiseMap = Promise.map ||
    function mapImpl(promiseList, functor) {
        return Promise.all(promiseList.map((promiseOrValue) => Promise.resolve(promiseOrValue).then(functor)));
    };
const promiseProps = Promise.props ||
